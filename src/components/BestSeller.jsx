   ...
   setBestSeller(bestProduct.slice(0,5))
    ...
    <div className='my-10'>
      <div className='text-center text-3xl py-8'>
        ...
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis rem laudantium ut quidem ab facilis nemo. Facere dicta ipsam magnam accusamus illo deleniti maiores est fugiat, nam nostrum. Delectus, voluptate. 
        </p>
      </div>
