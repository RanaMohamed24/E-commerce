...
const Collection = () => {
  ...
  useEffect(() => {
    applyFilter();
  }, [category, subCategory, sortOrder]); // Reapply filter whenever category, subCategory, or sortOrder changes
    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t flex-grow">
        <div className="min-w-60">
          ...
          >
            FILTERS
            <img className={`h-3 sm:hidden ${showFilter ? 'rotate-90' : ''}`} src='assets/dropdown_icon.svg' alt="Dropdown Icon" />
          </p>
          <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:b1`}>
          ...
          <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter ? '' : 'hidden'} sm:b1`}>
